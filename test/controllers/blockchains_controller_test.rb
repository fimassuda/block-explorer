...
class BlockchainsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create blockchain" do
    assert_difference("Blockchain.count") do
      post blockchains_url, params: { blockchain: { endpoint: @blockchain.endpoint, name: @blockchain.name } }
    end
  ...
  test "should update blockchain" do
    patch blockchain_url(@blockchain), params: { blockchain: { endpoint: @blockchain.endpoint, name: @blockchain.name } }
