...
class ActionsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create action" do
    assert_difference("Action.count") do
      post actions_url, params: { action: { deposit: @action.deposit, gas: @action.gas, method_name: @action.method_name, type: @action.action_type } }
    end
  ...
  test "should update action" do
    patch action_url(@action), params: { action: { deposit: @action.deposit, gas: @action.gas, method_name: @action.method_name, type: @action.action_type } }
